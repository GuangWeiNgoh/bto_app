...
def display():
    ...
    with st.form(key='filter_form'):
        ...
        button_col, warning_col, spacer2 = st.columns([1.5, 6, 9])  # Adjust the width ratio as needed
        ...
        with warning_col:
            st.write("Note: Results will update only after clicking on the Apply Filters button.")
